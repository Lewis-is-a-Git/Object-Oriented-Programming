...
${OBJECTDIR}/QuestionSet.o: QuestionSet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuestionSet.o QuestionSet.cpp
...
${OBJECTDIR}/Teacher.o: Teacher.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Teacher.o Teacher.cpp
...
${TESTDIR}/testQuestionSetclass.o: testQuestionSetclass.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testQuestionSetclass.o testQuestionSetclass.cpp


${TESTDIR}/tests/testmcqgrunner.o: tests/testmcqgrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testmcqgrunner.o tests/testmcqgrunner.cpp


${TESTDIR}/tests/testquestionclass.o: tests/testquestionclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testquestionclass.o tests/testquestionclass.cpp


${TESTDIR}/testteacherclass.o: testteacherclass.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testteacherclass.o testteacherclass.cpp
...
${OBJECTDIR}/Question_nomain.o: ${OBJECTDIR}/Question.o Question.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Question_nomain.o Question.cpp;\
	else  \
...
${OBJECTDIR}/QuestionSet_nomain.o: ${OBJECTDIR}/QuestionSet.o QuestionSet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuestionSet_nomain.o QuestionSet.cpp;\
	else  \
...
${OBJECTDIR}/Student_nomain.o: ${OBJECTDIR}/Student.o Student.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Student_nomain.o Student.cpp;\
	else  \
...
${OBJECTDIR}/Teacher_nomain.o: ${OBJECTDIR}/Teacher.o Teacher.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Teacher_nomain.o Teacher.cpp;\
	else  \
