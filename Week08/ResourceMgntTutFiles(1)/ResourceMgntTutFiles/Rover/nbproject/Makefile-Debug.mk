...
${TESTDIR}/testroverclass.o: testroverclass.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testroverclass.o testroverclass.cpp


${TESTDIR}/testroverrunner.o: testroverrunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testroverrunner.o testroverrunner.cpp
